...
export interface NFTMarketplaceInterface extends utils.Interface {
  ...
  encodeFunctionData(
    functionFragment: "createMarktSale",
  ...
  encodeFunctionData(
    functionFragment: "fetchMarktItems",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface NFTMarketplace extends BaseContract {
  ...
  estimateGas: {
    ...
    fetchMarktItems(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    fetchMarktItems(overrides?: CallOverrides): Promise<PopulatedTransaction>;
